...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Magasin.name'
        db.add_column('magasins_magasin', 'name', self.gf('django.db.models.fields.CharField')(default=datetime.date(2011, 11, 16), max_length=255), keep_default=False)

        # Changing field 'Magasin.cp'
        db.alter_column('magasins_magasin', 'cp', self.gf('django.db.models.fields.IntegerField')(max_length=5))


    def backwards(self, orm):
        
        # Deleting field 'Magasin.name'
        db.delete_column('magasins_magasin', 'name')

        # Changing field 'Magasin.cp'
        db.alter_column('magasins_magasin', 'cp', self.gf('django.db.models.fields.CharField')(max_length=5))
