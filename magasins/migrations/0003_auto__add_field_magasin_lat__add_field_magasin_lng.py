...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Magasin.lat'
        db.add_column('magasins_magasin', 'lat', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=13, decimal_places=10), keep_default=False)

        # Adding field 'Magasin.lng'
        db.add_column('magasins_magasin', 'lng', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=13, decimal_places=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Magasin.lat'
        db.delete_column('magasins_magasin', 'lat')

        # Deleting field 'Magasin.lng'
        db.delete_column('magasins_magasin', 'lng')
