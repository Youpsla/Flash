...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Magcli.temps_home_voiture'
        db.add_column('commandes_magcli', 'temps_home_voiture', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Magcli.temps_home_voiture'
        db.delete_column('commandes_magcli', 'temps_home_voiture')
    ...
    models = {
        ...
        'commandes.magcli': {
            ...
            'temps_home_voiture': ('django.db.models.fields.DateTimeField', [], {'null': 'True'})
        },
