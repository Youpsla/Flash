...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Magcli.distance_home_pied'
        db.add_column('commandes_magcli', 'distance_home_pied', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Magcli.distance_home_voiture'
        db.add_column('commandes_magcli', 'distance_home_voiture', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Magcli.distance_pro_pied'
        db.add_column('commandes_magcli', 'distance_pro_pied', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Magcli.distance_pro_voiture'
        db.add_column('commandes_magcli', 'distance_pro_voiture', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Magcli.distance_home_pied'
        db.delete_column('commandes_magcli', 'distance_home_pied')

        # Deleting field 'Magcli.distance_home_voiture'
        db.delete_column('commandes_magcli', 'distance_home_voiture')

        # Deleting field 'Magcli.distance_pro_pied'
        db.delete_column('commandes_magcli', 'distance_pro_pied')

        # Deleting field 'Magcli.distance_pro_voiture'
        db.delete_column('commandes_magcli', 'distance_pro_voiture')
    ...
    models = {
        ...
        'commandes.magcli': {
            ...
            'distance_home_pied': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'distance_home_voiture': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'distance_pro': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'distance_pro_pied': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'distance_pro_voiture': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
