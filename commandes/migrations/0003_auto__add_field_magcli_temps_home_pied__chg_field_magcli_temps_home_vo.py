...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Magcli.temps_home_pied'
        db.add_column('commandes_magcli', 'temps_home_pied', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Changing field 'Magcli.temps_home_voiture'
        db.alter_column('commandes_magcli', 'temps_home_voiture', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Magcli.temps_home_pied'
        db.delete_column('commandes_magcli', 'temps_home_pied')

        # Changing field 'Magcli.temps_home_voiture'
        db.alter_column('commandes_magcli', 'temps_home_voiture', self.gf('django.db.models.fields.DateTimeField')(null=True))
