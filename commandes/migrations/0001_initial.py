...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Magcli'
        db.create_table('commandes_magcli', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.Customer'])),
            ('magasin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['magasins.Magasin'])),
            ('distance_home', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('distance_pro', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('match_category', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal('commandes', ['Magcli'])

        # Adding unique constraint on 'Magcli', fields ['client', 'magasin']
        db.create_unique('commandes_magcli', ['client_id', 'magasin_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Magcli', fields ['client', 'magasin']
        db.delete_unique('commandes_magcli', ['client_id', 'magasin_id'])

        # Deleting model 'Magcli'
        db.delete_table('commandes_magcli')
